 ...
 * Generated at: 2019-12-27 03:30:33 UTC
...
public final class itemList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	System.out.println("imgMap.get(1).get(0).getItemImageDefault()="+imgMap.get(1).get(0).getItemImageDefault()); */
      ...
      out.write("\t");
		...
		if(itemList!=null && !itemList.isEmpty()) {
			for(int i=0; i<itemList.size(); i++){
				...
				int discountedPrice = (int)Math.ceil((item.getItemPrice()*0.95)/14);
      ...
      out.print(((int)Math.ceil((item.getItemPrice()*0.95)/14)/100)*100 );
