            ...
            <div class="container-fluid contents">
                ...
                <form action="<%=request.getContextPath()%>/admin/itemUpdateEnd" class="p-0 col-md-8 col-sm-8 col-xs-8 col-md-offset-2" method="post" enctype="multipart/form-data">
                    ...
                    <div class="container-fluid" id="category">
                        ...
                        <div class="container-fluid border-no-top">
                            <label class="radio-inline col-md-4 m-0 padding-left-25">
                                <input type="radio" name="category" id="inlineCheckbox1" value="CT01" <%="CT01".equals(i.getCategoryNo())?"checked":"" %>> 반려동물과 함께할 때
                            </label>
                        
                            <label class="radio-inline col-md-4 m-0 padding-left-25 border-side">
                                <input type="radio" name="category" id="inlineCheckbox2" value="CT02" <%="CT02".equals(i.getCategoryNo())?"checked":"" %>> 육아할 때
                            </label>

                            <label class="radio-inline col-md-4 m-0 padding-left-25">
                                <input type="radio" name="category" id="inlineCheckbox3" value="CT03" <%="CT03".equals(i.getCategoryNo())?"checked":"" %>> 행사, 파티할 때
                            </label>
                        
                            <label class="radio-inline col-md-4 m-0 padding-left-25 border-top">
                                <input type="radio" name="category" id="inlineCheckbox1" value="CT04" <%="CT04".equals(i.getCategoryNo())?"checked":"" %>> 운동할 때
                            </label>

                            <label class="radio-inline col-md-4 m-0 padding-left-25 border-side border-top">
                                <input type="radio" name="category" id="inlineCheckbox2" value="CT05" <%="CT05".equals(i.getCategoryNo())?"checked":"" %>> 여행갈 때
                            </label>

                            <label class="radio-inline col-md-4 m-0 padding-left-25 border-top">
                                <input type="radio" name="category" id="inlineCheckbox3" value="CT06" <%="CT06".equals(i.getCategoryNo())?"checked":"" %>> 캠핑갈 때
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid" id="item-name">
                        ...
                        <div class="container-fluid border-no-top height-45">
                            <input type="number" class="form-control shadow-none no-round-border height-45" id="inputItemCount" name="itemStock" placeholder="상품수량을 입력하세요" value=<%=i.getItemStock() %>>
                        </div>
                    </div>
